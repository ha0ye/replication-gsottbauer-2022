...
Payments](replication-survey1_files/figure-gfm/unnamed-chunk-3-1.png)
...
xx <- dat_study1 %>%
    mutate(income = factor(dat_study1$income, 
...
xx %>%
    ggplot(aes(x = as.factor(income), group = priming)) + 
...
![](replication-survey1_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
